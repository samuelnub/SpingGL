...
namespace XMLDefaults
{
	const char *graphicsSettings =
	{
		...
		"    <maxLod>7</maxLod>"
		"	"
		"    <universeMaxCount>1</universeMaxCount>"
		"    <universeCellSize>512.0f</universeCellSize>"
		"    <universeCellWidthCount>1024</universeCellWidthCount>"
		"   "
		"    <galaxyMaxCount>1</galaxyMaxCount>"
		"    <galaxyCellSize>0.5f</galaxyCellSize>"
		"    <galaxyCellWidthCount>1024</galaxyCellWidthCount>"
		"  </GraphicsSettings>"
		"</root>"
	};
	...
	const char *userSettings =
	{
		...
		"  <UserSettings>"
		"    <zNear>0.1f</zNear>"
		"    <zFar>5000000.0f</zFar>"
		"    <fov>75.0</fov>"
		"	"
		"    <mouseLookSensitivity>0.005</mouseLookSensitivity>"
